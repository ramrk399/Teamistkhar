...
from BrandrdXMusic import BOT_ID, LOGGER, app
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"BrandrdXMusic/assets/circle.png")
        ...
        font = ImageFont.truetype("BrandrdXMusic/assets/font2.ttf", 45)
        ImageFont.truetype("BrandrdXMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("BrandrdXMusic/assets/font2.ttf", 30)
        ImageFont.truetype("BrandrdXMusic/assets/font.ttf", 30)
